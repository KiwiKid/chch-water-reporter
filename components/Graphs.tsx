...
export default function Graphs() {
  ...
  return (<>
    ...
    {status === 'fetched' && propertyGroups && <div style={{textAlign: 'center', width: '100%', backgroundColor: 'white', color: 'black'}}>
        ...
        >
          <ReferenceLine x={9} label="Charges apply" stroke="black" isFront={true} strokeDasharray="3 3" />
          <CartesianGrid strokeDasharray="3 3" />
          <YAxis>
            # address using this amount
          </YAxis>
          <XAxis dataKey="name" >
            <Label value={`Avg Lts used (in hundreds)\n`} offset={3} position="insideBottom" />
            </XAxis>
