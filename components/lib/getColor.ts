...
const colorMap:StyleData[] = [
  {colorClass: 'low-level', colorCode:'#EBF4FA', min: 0, max: 500},
  {colorClass: 'med-level', colorCode: '#B7CEEC', min: 500, max: 700},
  {colorClass: 'high-level', colorCode: '#659EC7', min: 700, max: 2000},
